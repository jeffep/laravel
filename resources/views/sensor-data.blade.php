...
titles.forEach(title => {
    ...
    const locations = ['bedrooms', 'den', 'garage', 'birdbath', 'birdcam', 'backporch', 'front', 'gardenmon'];
...
<!-- Chart Wrappers -->
@foreach(['bedrooms', 'den', 'garage', 'birdbath', 'birdcam', 'backporch', 'front', 'gardenmon'] as $location)
